...
namespace ReplyHelper
{
    public partial class SetOptionsForm : Form
    {
        ...
        {
            Option newOption = new ReplyHelper.Option();
            string message = "banana";//should get rich textbox
            string title = "orange"; //should get textbox
            newOption.GetMessage(message);
            newOption.GetTitle(title);      
        }
    }
}
